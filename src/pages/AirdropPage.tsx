            ...
            <Card bg='gray.100' height='700px'>
              <CardBody>
                ...
                <Flex alignItems='center' justifyContent='center'>
                  <Box mt={'10px'} boxShadow='lg' bg='yellow' h='50px' w='600px' borderRadius='lg'>
                    <Center w={'100%'} as='b' fontSize='3xl' color='red'>
                ...
                <Flex mt={'40px'} justifyContent={'center'}>
                  ...
                  >
                    <Container maxW={'500px'} w={'100%'}>
                      <Heading mt={'10px'}>Donate</Heading>
                  ...
                  <Center>
                    ...
                    >
                      <Container maxW={'500px'} w={'100%'}>
                        <Heading mt={'10px'}>Get Airdrop</Heading>
                        <Text mt={'25px'} color={'blackAlpha.800'}>
